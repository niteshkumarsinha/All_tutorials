  ...
  render() {
    return (
      <div className='Hangman'>
        ...
        <p className='Hangman-word'>{this.state.nWrong === 6 ? <p>{this.state.answer}</p>:this.guessedWord()}</p>
        ...
        <button onClick={this.restart} id='button' className='RestartButton'>Restart</button>
      </div>
    );
  }
}
